...
//assignment 5
var famous_peron = "Master Oogway";
...
function makeshirt2(size = 'large', message) {
    console.log('The size of the shirt is ' + size + ' and the message is ' + message);
}
...
//assignment 41 
function show_magicians(Magician = Magicians) {
...
//assignment 45
function Cars(manafacturer, model_name, color, power_steering) {
